...
//#### PinOUT ####
  //Player inputs
    uint8_t R_Button = 3; //Interupt            
    uint8_t S_Button = 49;    //              
  //Mechs
    uint8_t slingShot = 11; //                 
    uint8_t slingShotTrigger = 20; //Interupt   
    uint8_t R_FLipper = 12; //NEEDS PWM         
  //DropDown Target
    uint8_t dropDownTrigger = 35;//            
    uint8_t dropDownServo = 6; //NEEDS PWM      

  //Ball Launch mech
    uint8_t BL_1servo = 9;  //NEEDS PWM        
    uint8_t BL_2servo = 10;  //NEEDS PWM       
  ...
  /*Encoder Inputs
    0 Currently shorted, needs resoldered
    1 Target 1
    2 Target 2
    3 Target 3
    4
...
//Ball Launch Mechanism !!!! TODO !!!!
  Servo ballLaunch1;
  Servo ballLaunch2;
  bool launchBall, dropBall, delayStep, ballStep;  //LaunchBall is the operation active flag, the others are steps
